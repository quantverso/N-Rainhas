...
public:
	...
	void DrawPoints(const Vector2i* points, int count);
	void DrawLine(int x1, int y1, int x2, int y2);
	void DrawLines(const Vector2i* points, int count);
...
inline void Window::DrawPoints(const Vector2i* points, int count)
{
...
inline void Window::DrawLines(const Vector2i* points, int count)
{
