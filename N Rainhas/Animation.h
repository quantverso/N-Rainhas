...
public:
    ...
    /// 
    ////////////////////////////////////////////////////////////
    void Add(unsigned int id, std::vector<Rect> sequence, bool loop, bool continuous);
    ...
    /// 
    ////////////////////////////////////////////////////////////
    void Add(unsigned int id, Rect sequence);
    ...
    /// 
    ////////////////////////////////////////////////////////////
    bool Run(unsigned int id, float frameTime);
...
private:
    ...
    using RectMap = std::unordered_map<unsigned int, RectCoords>; ///< Mapa de animações.
    ...
    unsigned int lastIndex{}; ///< Último índice usado (para animações contínuas).
    unsigned int currentId{ std::numeric_limits<unsigned int>::max() }; ///< ID da animação atual.
